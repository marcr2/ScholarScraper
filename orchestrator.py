...
field = input("What field is your research in? (Ie. molecular biology, machine learning) ")
target_object = input("What would you like to group by? (Ie. treatment option, deep learning algorithm) ")
...
processed_data = llmRead(import_data, field, target_object) # categorize articles using LLM
